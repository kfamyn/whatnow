...
void HourlyForecastLine::setup(QString date, QString time, QString iconURL, QString precipitationProbability, QString currentTemperature)
{
    ...
    iconLabel = createIconLabel(iconURL, 120);
    ...
    //precipitationIconLabel = createIconLabel(":/additionalWeatherIcons/assets/additionalWeatherIcons/Precipitations.png", 3);
    precipitationIconLayout = new QVBoxLayout();
    precipitationIconLayout->setSpacing(0);
    ...
    precipitationProbabilityLayout->setSpacing(0);
    ...
    temperatureLabel = createTextLabel(currentTemperature, 39, QFont::Normal, "color: qconicalgradient(cx:0.5, cy:0.5, angle:0, stop:0 rgba(255,255,255,0), stop:0.9 rgba(255,255,255,255),  stop:1 rgba(202, 162, 203, 255));", Qt::AlignTop | Qt::AlignRight);
    ...
    hourlyForecastLayout->addWidget(iconLabel);
